			...
			<div class="ml-2">
				<div class="flex gap-2">
					...
					<span
						...
						<a href="#source_files" class="underline"> source files</a>
						&
						{metadata_prov_stats?.['result_entities']?.['results']?.['bindings']?.length}
						<a href="#result_files" class="underline"> result files</a>)
					</span>
				</div>
				<div class="flex gap-2">
					<span class="font-bold text-blue-400">Number of files based on this file:</span>
					<span
						><a href="#base_for_entities" class="underline"
...
{#if metadata_prov_stats}
	<div class="bg-box" id="source_files">
		<h2 class="text-lg font-semibold mb-3 flex items-center gap-2 text-white">
	...
	<div class="bg-box" id="result_files">
		<h2 class="text-lg font-semibold mb-3 flex items-center gap-2 text-white">
	...
	<div class="bg-box" id="base_for_entities">
		<h2 class="text-lg font-semibold mb-3 flex items-center gap-2 text-white">
