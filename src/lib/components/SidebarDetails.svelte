	...
	{#if detailedData?.parameter}
		<div class="relative">
			...
			>
				...
				>
					<path
						d="M14 2H9a2 2 0 00-2 2v12a2 2 0 002 2h6a2 2 0 002-2V4a2 2 0 00-2-2zM9 4h6v12H9V4z"
					/>
					<path d="M4 6a1 1 0 011-1h3a1 1 0 011 1v3a1 1 0 11-2 0V7H6v2a1 1 0 01-2 0V6z" />
				</svg>
			</button>
			<h2>{''}</h2>
			<div class="triangle absolute left-1/2 -top-2 transform -translate-x-1/2" />
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<span
									class="info-icon"
									title="A regional climate model simulates climate at a finer resolution for a specific geographical area, providing detailed local climate predictions."
								>
						...
						<tr>
							...
							<td>
								...
								<span
									class="info-icon"
									title="A global climate model simulates climate patterns and changes across the entire Earth, typically at a coarser resolution."
								>
									<i class="fas fa-info-circle" aria-hidden="true" />
								</span>
							</td>
						...
						<tr>
							...
							<td>
								...
								<span
									class="info-icon"
									title="A data format specifies the structure and type of data storage, ensuring compatibility for processing and analysis, such as NetCDF for climate data."
								>
									<i class="fas fa-info-circle" aria-hidden="true" />
								</span>
							</td>
						...
						<tr>
							...
							<td>
								...
								<span
									class="info-icon"
									title="A climate scenario represents a set of projected socio-economic pathways used to model future climate conditions, such as SSP-5 for high emissions."
								>
									<i class="fas fa-info-circle" aria-hidden="true" />
								</span>
							</td>
						...
						<tr>
							...
							<td>
								...
								<span
									class="info-icon"
									title="The 'r1i1p1f1' is the control simulation of a CMIP6 model, using standard settings, while other ensemble members are derived from small variations of the control, representing equally valid future climate outcomes influenced by slight changes in initial conditions."
								>
									<i class="fas fa-info-circle" aria-hidden="true" />
								</span>
							</td>
						...
						<tr>
							...
							<td>
								...
								<span
									class="info-icon"
									title="Temporal Resolution (T → Time separator, nS → Second, P - Period) (nM → Minutes, nH → Hours, nD → Days, nW → Weeks, nM → Months, nY → Years)"
								>
									<i class="fas fa-info-circle" aria-hidden="true" />
								</span>
							</td>
						...
						<tr>
							...
							<td>
								...
								<span
									class="info-icon"
									title="Climate data standards, such as CF (Climate and Forecast) conventions, are defined by the CF community to ensure interoperability and consistent metadata in climate model outputs; they are documented at cfconventions.org."
								>
									<i class="fas fa-info-circle" aria-hidden="true" />
								</span>
							</td>
						...
						<tr>
							...
							<td>
								...
								<span
									class="info-icon"
									title="Represents a specific geographic region at defined resolution, used for downscaling global climate model data to finer scales."
								>
									<i class="fas fa-info-circle" aria-hidden="true" />
								</span>
							</td>
						...
						<tr>
							...
							<td>
								{#if detailedData.doi !== 'N/A'}
									<a
										href={detailedData.doi.startsWith('http')
											? detailedData.doi
											: `https://doi.org/${detailedData.doi}`}
										target="_blank"
								...
								{#if detailedData.doi_hist !== 'N/A'}
									<a
										href={detailedData.doi_hist.startsWith('http')
											? detailedData.doi_hist
											: `https://doi.org/${detailedData.doi_hist}`}
										target="_blank"
										rel="noopener noreferrer"
										class="text-blue-600 underline hover:text-blue-800"
									>
