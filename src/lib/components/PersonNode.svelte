...
>
	...
	<div class="flex flex-col space-y-3 w-full">
		...
		<div class="flex space-x-2 w-full">
			<!-- Person Chip -->
			<div
				class="bg-[#FFF9E5] text-[#424242] border border-[#E8CC71] font-bold px-4 py-2 rounded-md text-lg flex-grow text-center hover:bg-white transition-colors duration-200"
			>
				{data.person}
			</div>
			<!-- Organisation Chip -->
