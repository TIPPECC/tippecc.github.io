<script lang="ts">
    ...
    */
				...
				color: [
					...
					[
						...
						...getColorStops(
							...
							current_band_metainfo.min,
							current_band_metainfo.max,
							50,
							invert_colors
						)
					]
	...
	async function band_selected_via_slider(e?) {
		...
		let band_index_helper = get_index_from_band_via_value(
			band_slider_values[sliderValue].toString()
		);
	...
	function file_selected(e?) {
		...
		let selected_file_url =
			'https://leutra.geogr.uni-jena.de/tippecc_data/tmp/water_budget/' + selected_file;

		// begin card assembling
		load_file_metadata(selected_file_url)
			.then((result) => {
			...
			<div class="flex">
				...
				{#if selected_color_theme == 'jet'}
					...
					<svg width="150" height="30">
						<rect width="30" height="30" fill="#000083" x="0" y="0" />
						<rect width="30" height="30" fill="#039ed5" x="30" y="0" />
						<rect width="30" height="30" fill="#82ff80" x="60" y="0" />
						<rect width="30" height="30" fill="#fd8000" x="90" y="0" />
						<rect width="30" height="30" fill="#800000" x="120" y="0" />
					</svg>
				{:else if selected_color_theme == 'hot'}
					<!-- HOT -->
					<svg width="150" height="30">
						<rect width="30" height="30" fill="#000000" x="0" y="0" />
						<rect width="30" height="30" fill="#e60000" x="30" y="0" />
						<rect width="30" height="30" fill="#f78c00" x="60" y="0" />
						<rect width="30" height="30" fill="#ffe155" x="90" y="0" />
						<rect width="30" height="30" fill="#ffffff" x="120" y="0" />
					</svg>
				{:else if selected_color_theme == 'cool'}
					<!-- COOL -->
					<svg width="150" height="30">
						<rect width="30" height="30" fill="#7d00b3" x="0" y="0" />
						<rect width="30" height="30" fill="#624aed" x="30" y="0" />
						<rect width="30" height="30" fill="#00ccc5" x="60" y="0" />
						<rect width="30" height="30" fill="#00ff58" x="90" y="0" />
						<rect width="30" height="30" fill="#93ff00" x="120" y="0" />
					</svg>
				{/if}
